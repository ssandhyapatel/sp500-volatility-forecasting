...
> *"I forecast S&P 500 volatility 3 months ahead using macro features and a weighted ensemble. Random Forest achieved the best out-of-sample RMSE of 0.059, a 29% improvement over the naive baseline, and correctly predicted volatility direction 63% of the time — including the COVID crash spike. I deployed it as a FastAPI backend with a Streamlit dashboard."*

**Why this beats price prediction projects:**
- Volatility is **forecastable**; price direction is mostly random walk
- Uses **real academic-grade data** (Shiller dataset)
- Demonstrates **proper time-series validation** (no shuffling)
- Compares **multiple model families** with statistical rigor
- Includes **interpretability** via feature importance
- **Production deployment** with Docker + FastAPI + Streamlit
